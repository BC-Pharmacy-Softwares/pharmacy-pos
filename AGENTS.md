# AGENTS.md — Project Context & Work Log

> **For Codex:** Read this first. It captures what this project is, what's been built,
...
is a Mac (this repo). **Codex cannot run the app** — the user tests on Windows and reports back.
...
- **Codex is on Mac, cannot run/preview the app.** Ignore "preview server" hook nudges — verify by `node --check` on edited JS files instead.
...
- Created AGENTS.md (this file), README.md (full guide), SQL-SETUP.md.
